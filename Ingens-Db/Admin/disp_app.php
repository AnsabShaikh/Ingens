        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <table class="table table-bordered table-striped table-responsive-lg table-responsive-md table-responsive-sm">
                    ...
                    <?php
                    $q = mysqli_query($con, "select * from hot_job");
                    ...
                    while ($row = mysqli_fetch_array($q)) {
                        ...
                        <tr>
                            ...
                            <td><a class="btn btn-outline-primary" href="uploads/<?php echo $row['resume'] ?>">Download</a></td>
                            <td><a href="delete_app.php?id=<?php echo $row['id'] ?>"><input type="button" class="btn btn-primary" value="Delete"></a></td>
