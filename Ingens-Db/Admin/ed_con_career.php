    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-10 col-sm-12 col-lg-10">
                ...
                <hr>
                <?php
                $q = mysqli_query($con, "select * from con_career WHERE id='$id'");
                $row = mysqli_fetch_array($q);
                ?>
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-4 col-sm-12 col-lg-4">
                            <label for="" class="l">E-mail Id</label>
                        </div>
                        <div class="col-md-5 col-sm-12 col-lg-5">
                            <input type="email" class="in" name="mail"  value="<?php echo $row['mail']?>">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4 col-sm-12 col-lg-4">
...
window.location = "Edit_education.php";
        ...
        $query = mysqli_query($con, "update con_career set mobile='$i',mail='$j' WHERE id='$id'");
