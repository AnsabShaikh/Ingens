...
<div class="container">
    <div class="row">
        <div class="col-md-6 col-sm-12 col-lg-6">
            <a href="career_at.php"><button class="btn btn-info" style="margin-top: 20px;margin-left: 20px">Back</button></a>
        </div>
        <div class="col-md-5 col-sm-12 col-lg-5">
            <a href="add_con_career.php"><button class="btn btn-info" style="margin-top: 20px;margin-left: 300px">Add New</button></a>
        </div>
    </div>
</div>
    <!--<div class="parallax1">-->
                ...
                <table class="table table-bordered table-striped table-responsive-lg table-responsive-md table-responsive-sm">
                    ...
                    while ($row = mysqli_fetch_array($q)) {
                        ...
                        <tr>
                            ...
                            <td><a href="ed_con_career.php?id=<?php echo $row['id'] ?>"><input type="button" style="width: 70px" class="btn btn-primary" value="Edit"></a>
                                <a href="delete_con_career.php?id=<?php echo $row['id'] ?>"><input type="button" class="btn btn-primary" value="Delete"></a></td>
