        ...
        <div class="row">
            ...
            <div class="col-md-10 col-sm-12 col-lg-10">
                ...
                <div class="container text-center">
                    <h1><label for="" class="txt">Edit Education Requirement Details
                        </label></h1>

                </div>
                <hr>
                <?php
                $q = mysqli_query($con, "select * from education WHERE id='$id'");
                $row = mysqli_fetch_array($q);
                ?>
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-4 col-sm-12 col-lg-4">
                            <label for="" class="l">Education Requirement</label>
                        </div>
                        <div class="col-md-5 col-sm-12 col-lg-5">
                            <input type="text" class="in" name="txt"  value="<?php echo $row['text']?>">
                        </div>
                    </div>
...
window.location = "Edit_education.php";
        ...
        $query = mysqli_query($con, "update education set text='$i' WHERE id='$id'");
