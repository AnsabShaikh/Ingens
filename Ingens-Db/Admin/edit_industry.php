    ...
    <div class="container">
        <div class="row">
            <div class="col-md-2 col-sm-12 col-lg-2">
                <a href="industry.php"><button class="bt1 btn-outline-info">Back</button></a>
            </div>
            <div class="col-md-10 col-sm-12 col-lg-10">

                <div class="container text-center">
                    <h1><label for="" class="txt">Edit Industry Practices
                        </label></h1>

                </div>
                <hr>
                <?php
                $q = mysqli_query($con, "select * from industry WHERE id='$id'");
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-12 col-lg-4">
                            <label for="" class="l">Title Of The Industry</label>
                        </div>
                        <div class="col-md-5 col-sm-12 col-lg-5">
...
window.location = "industry.php";
        ...
        $query = mysqli_query($con, "update industry set image_file='$upload',title='$name' WHERE id='$id'");
