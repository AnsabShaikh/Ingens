    ...
    <div class="row">
        <div class="col-md-10 col-sm-12 col-lg-10">
            <form action="" class="for" method="post" enctype="multipart/form-data">
                ...
                <div class="m row">
                    <div class="col-md-6 col-sm-12 col-lg-6">
                        <label class="l" for="">E-mail Id</label>
                    </div>
                    <div class="col-md-3 col-sm-12 col-lg-3">
                        <input type="email" name="mail" class="in"  placeholder="Email Id">
                    </div>
                </div>
...
if(isset($_POST['add'])){
    ...
    if ($a == "" || $b == "") {
        ...
        echo '<script>
                ...
                window.location = "add_con_career.php";
                //document.f1.email.focus();
              </script>';
    }
    else

    $q = mysqli_query($con, "insert into con_career(mobile,mail) VALUES('$a','$b') ");
    if ($q)
    {
        echo '<script>
