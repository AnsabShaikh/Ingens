...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-10  col-sm-12 col-lg-10">
            <h1 class="txt">Add Details About The Services</h1>
        </div>
    </div>
</div>
<br><br>
            ...
            <form action="" class="for" method="post" enctype="multipart/form-data">
                <div class="m row">
                    ...
                    <div class="col-md-3 col-sm-12 col-lg-3">
                        <input type="text" name="job" class="in"  placeholder="Job Title ">
                    </div>
                </div>
                <div class="m row">
                    <div class="col-md-6 col-sm-12 col-lg-6">
                    ...
                    <div class="col-md-3 col-sm-12 col-lg-3">
                        <input type="text" name="req" class="in" placeholder="Requirement">
                    </div>
                </div>
                <div class="m row">
                    <div class="col-md-6 col-sm-12 col-lg-6">
                    ...
                    <div class="col-md-3 col-sm-12 col-lg-3">
                        <input type="text" class="in" name="vac" placeholder="Vaccancies">
                    </div>
                </div>
...
//    $h = $_POST['email'];
    ...
    if ($a == "" || $b == ""|| $i == "") {
        ...
        echo '<script>
                ...
                window.location = "add_jobs.php";
                //document.f1.email.focus();
              </script>';
    }
    else

    $q = mysqli_query($con, "insert into job(job,req,vac) VALUES('$a','$b','$i') ");
    if ($q)
    {
        echo '<script>
