...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-10  col-sm-12 col-lg-10">
            <h1 class="txt">Add Hiring Details</h1>
        </div>
    </div>
</div>
<br><br>
            ...
            <form action="" class="for" method="post" enctype="multipart/form-data">
                <div class="m row">
                    <div class="col-md-6 col-sm-12 col-lg-6">
                        <label class="l" for="">Hiring Position</label>
                    </div>
                    <div class="col-md-3 col-sm-12 col-lg-3">
                        <input type="text" name="text" class="in"  placeholder="Job Title ">
                    </div>
                </div>
...
if(isset($_POST['add'])){
    ...
    if ($a == "") {
        ...
        echo '<script>
                ...
                window.location = "add_hiring.php";
    ...
    $q = mysqli_query($con, "insert into hiring(text) VALUES('$a') ");
    if ($q)
    {
        echo '<script>
