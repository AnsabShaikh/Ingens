    ...
    <div class="row">
        ...
        <div class="col-md-10 col-sm-12 col-lg-10">
            ...
            <div class="container text-center">
                <h1><label for="" class="txt">Edit Technology
                    </label></h1>

            </div>
            <hr>
            <?php
            $q = mysqli_query($con, "select * from home_card WHERE id='$id'");
            $row = mysqli_fetch_array($q);
            ?>
            <form action="" method="post" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-3 col-sm-12 col-lg-3">
                        <label for="" class="l">Image</label>
                    </div>
                    <div class="col-md-5 col-sm-12 col-lg-5">
                        <input type="file" name="image_file" class="in"  value="<?php echo $row['image_file'] ?>">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-3 col-sm-12 col-lg-3">
                        <label for="" class="l">Title Of The Service</label>
                    </div>
                    <div class="col-md-5 col-sm-12 col-lg-5">
                        <input type="text" name="title_text" class="in"
                               value="<?php echo $row['title_text']?>">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-3 col-sm-12 col-lg-3">
                        <label for="" class="l">Data Of Service</label>
                    </div>
                    <div class="col-md-5 col-sm-12 col-lg-5">
                        <input type="text" name="text" class="in"  value="<?php echo $row['data_text']?>">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-3 col-sm-12 col-lg-3">
                        <label for="" class="l">Link For Service</label>
                    </div>
                    <div class="col-md-5 col-sm-12 col-lg-5">
                        <input type="text" class="in" name="link"  value="<?php echo $row['more_link']?>">
                    </div>
                </div>
...
window.location = "home.php";
        ...
        $query = mysqli_query($con, "update home_card set image_file='$upload',title_text='$name',data_text='$data1',more_link='$i' WHERE id='$id'");
