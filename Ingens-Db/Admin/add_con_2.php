...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-10  col-sm-12 col-lg-10">
            <h1 class="txt">Add Contact Details</h1>
        </div>
    </div>
</div>
<br><br>
            ...
            <form action="" class="for" method="post" enctype="multipart/form-data">
                <div class="m row">
                    <div class="col-md-6 col-sm-12 col-lg-6">
                        <label class="l" for="">Title of Contact</label>
                    </div>
                    <div class="col-md-3 col-sm-12 col-lg-3">
                        <input type="text" name="text" class="in"  placeholder="Title of Contact">
                    </div>
                </div>
                <div class="m row">
                    <div class="col-md-6 col-sm-12 col-lg-6">
                        <label class="l" for="">Mobile Number</label>
                    </div>
                    <div class="col-md-3 col-sm-12 col-lg-3">
                        <input type="number" name="mobile" class="in"  placeholder="Mobile Number">
                    </div>
                </div>
...
if(isset($_POST['add'])){
    ...
    $q = mysqli_query($con, "insert into contact_2(text,mobile) VALUES('$a','$b') ");
    if ($q)
    {
        echo '<script>
