    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-10 col-sm-12 col-lg-10">
                ...
                <hr>
                <?php
                $q = mysqli_query($con, "select * from contact_1 WHERE id='$id'");
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-md-5 col-sm-12 col-lg-5">
                            <input type="text" class="in" name="text"  value="<?php echo $row['text']?>">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4 col-sm-12 col-lg-4">
...
window.location = "Edit_con1.php";
        ...
        $query = mysqli_query($con, "update contact_1 set text='$i',mobile='$j' WHERE id='$id'");
