        ...
        <div class="row">
            ...
            <div class="col-md-10 col-sm-12 col-lg-10">
                ...
                <div class="container text-center">
                    <h1><label for="" class="txt">Edit Hiring Details
                        </label></h1>

                </div>
                <hr>
                <?php
                $q = mysqli_query($con, "select * from hiring WHERE id='$id'");
                $row = mysqli_fetch_array($q);
                ?>
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-4 col-sm-12 col-lg-4">
                            <label for="" class="l">Hiring Position</label>
                        </div>
...
window.location = "Edit_hiring.php";
        ...
        $query = mysqli_query($con, "update hiring set text='$i' WHERE id='$id'");
