...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-10  col-sm-12 col-lg-10">
            <h3 class="txt">Add Details About The Industry Practices</h3>
        </div>
    </div>
</div>
<br><br>
    ...
    <div class="row">
        <div class="col-md-10 col-sm-12 col-lg-10">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-12 col-lg-3">
                        <label class="l" for="">Enter Title</label>
                    </div>
                    <div class="col-md-4 col-sm-12 col-lg-4">
                        <input type="text" name="title"  class="in"  placeholder="Enter Title">
                    </div>
                </div>
...
//    $i = $_POST['link'];
    ...
    if ($a == "" || $upload == "") {
        ...
        window.location = "add_industry.php";
        //document.f1.email.focus();
         </script>';
    }
    else
        $q = mysqli_query($con, "insert into industry(image_file, title) VALUES('$upload','$a') ");
    if ($q)
    {
        echo '<script>
